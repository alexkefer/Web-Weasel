...
function ToggleButton() {
    ...
    const toggleIcon = () => {
        const newIconSrc = iconSrc.includes('on_power_icon.png') ? '../images/off_power_icon.png' : '../images/on_power_icon.png';
        ...
        toggleDeviceInfoVisibility(newIconSrc.includes('on_power_icon.png'), randomData);
    };
